...
interface HighlightsProps { navigation: any; }

const HighlightsScreen: React.FC<HighlightsProps> = ({ navigation }) => {
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={[styles.header, { backgroundColor: theme.surface, borderBottomColor: theme.border }]}>
        ...
        <View style={styles.headerCenter}>
          <Text style={[styles.headerTitle, { color: theme.text }]}>Highlights</Text>
          <Text style={[styles.headerSubtitle, { color: theme.textSecondary }]}>Game Highlights</Text>
        </View>
      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={[styles.card, { backgroundColor: theme.card }]}>
          <Text style={[styles.cardTitle, { color: theme.text }]}>🎥 Game Highlights</Text>
          <Text style={[styles.placeholderText, { color: theme.textSecondary }]}>
            Video highlights and social media reactions will be displayed here
          </Text>
        </View>
      </ScrollView>
    </View>
